...
function problem5($arr, $arr1) {
    ...
    echo $result. strip_tags(nl2br("\n"));
    
    // 2.
    $arr_merge = array_push($arr, 20, 35, 46, 3);
    echo $arr_merge. strip_tags(nl2br("\n"));
    ...
    foreach ($make_array AS $arr_val) {
        echo $arr_val. strip_tags(nl2br("\n"));
    }
    
    // 4.
    $nuw_time = time();
    $get_tiem = mktime(1);
    echo $nuw_time. strip_tags(nl2br("\n"));
    echo $get_tiem. strip_tags(nl2br("\n"));
